...
/**
 * Index Component - GlazionStudio Chat Interface
 * Note: Now used within AppShell layout, so no need for Header/Sidebar here
 */
  ...
  return (
    <div className="h-full flex flex-col relative">
      <ClipboardUpload onImagePaste={(file) => {
        ...
        <div
          ref={promptWrapRef}
          className="absolute bottom-0 left-0 right-0 z-30 pb-4"
          style={{
